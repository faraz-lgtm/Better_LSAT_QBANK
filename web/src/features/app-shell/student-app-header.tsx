    ...
    <header className="app-nav-header sticky top-0 z-20">
      <div className="app-nav-shell">
        ...
        <div className="app-nav-group app-nav-actions">
          <button type="button" className="app-nav-icon-btn" aria-label="Notifications">
          ...
          <div ref={profileMenuRef} className="relative">
            ...
            >
              <span className="flex size-8 items-center justify-center rounded-full bg-[#0d47a1] text-xs font-semibold text-white">
                {initials}
              </span>
              <span className="hidden flex-col items-start text-left leading-tight text-[#062357] sm:flex">
                <span className="text-sm font-semibold tracking-[0.02em]">{displayName}</span>
                <span className="max-w-[180px] truncate text-[11px] font-normal tracking-[0.02em] text-[#666d80]">
                  {email ?? "student@example.com"}
                </span>
              </span>
              <span className="flex size-7 items-center justify-center text-[#666d80]">
                <ChevronDown className={cn("size-4 transition-transform", openProfileMenu ? "rotate-180" : "")} />
              </span>
            </button>
            {openProfileMenu ? (
