  ...
  return (
    <div ref={containerRef} className={cn("relative", className)}>
      <button
        ...
        className="flex h-[52px] w-auto min-w-[188px] items-center gap-2 rounded-[16px] border border-[#dfe1e7] bg-white px-4 text-[16px] font-medium leading-normal text-[#666d80] transition-colors hover:bg-[#f3f7ff] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0d47a1]/30"
      >
