...
function RcDrillPassageHeader({ passage }: { passage: PracticePassageSummary }) {
  return (
    <div className="min-w-0 rounded-t-[24px] border border-[var(--greyscale-100)] bg-[var(--primary-0)] p-6">
      <div className={PT_RESULTS_DETAIL_ROW_CLASS}>
        ...
        <div className={PT_RESULTS_DETAIL_GRID_CLASS}>
          ...
          <button
            type="button"
            className="flex size-9 shrink-0 items-center justify-center rounded-[12px] border border-[var(--greyscale-100)] bg-[var(--greyscale-25)] text-[var(--greyscale-500)] transition-colors hover:bg-[var(--greyscale-0)]"
      ...
      {visiblePassages.length > 0
        ? visiblePassages.map((group) => (
            <section
              ...
              className="min-w-0 overflow-hidden rounded-[24px] border border-[var(--greyscale-100)] bg-[var(--greyscale-0)] p-6"
            >
