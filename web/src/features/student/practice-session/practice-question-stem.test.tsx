...
describe("PracticeQuestionStem", () => {
  it("uses 15px / 22px / regular for official stem number and copy", () => {
    render(
    ...
    expect(screen.getByText("1 .")).toHaveClass("text-[15px]", "font-normal", "leading-[22px]")
    const stem = screen
    ...
    expect(stem).toHaveClass("text-[15px]", "font-normal", "leading-[22px]")
