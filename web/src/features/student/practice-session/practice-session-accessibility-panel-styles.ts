...
const PRACTICE_SESSION_ACCESSIBILITY_PANEL_CLASS =
  "my-auto flex h-auto w-full max-w-[640px] flex-col overflow-visible rounded-[16px] border border-[var(--greyscale-100)] bg-[var(--greyscale-0)] shadow-[0px_24px_24px_rgba(13,13,18,0.12)]"
...
const PRACTICE_SESSION_ACCESSIBILITY_PANEL_TABS_CLASS =
  "flex h-auto shrink-0 flex-wrap items-center gap-6 overflow-visible border-b border-[var(--greyscale-100)] px-6"
...
const PRACTICE_SESSION_ACCESSIBILITY_PANEL_BODY_CLASS = "h-auto px-6 py-5"
