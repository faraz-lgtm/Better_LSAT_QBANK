...
function LessonDrillIntroCard({
  ...
  return (
    <article className="w-full rounded-2xl border border-[#dfe1e7] bg-white p-6 shadow-[0px_1px_2px_0px_rgba(13,13,18,0.06)]">
      {hideTitle ? null : (
      ...
      <div className={hideTitle ? undefined : "pt-6"}>
        <p className={`ds-body-sm leading-7 text-[#36394a] ${hideTitle ? "mt-0" : ""}`}>{body}</p>
